...
<body class="cbp-spmenu-push">
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Add new patient<h3>
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Telephone number</label> <input type="text" class="form-control" id="mobilenum" name="mobilenum" placeholder="Mobile Number" value="" required="true" maxlength="10" pattern="[0-9]+"> </div>
							 <div class="radio">

                               <p style="padding-top: 20px; font-size: 15px"> <strong>Sex:</strong> <label>

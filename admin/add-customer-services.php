...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Appoint a doctor</h3>
					
					
				
					<div class="table-responsive bs-example widget-shadow">
						<h4>Appint a doctor:</h4>
<form method="post">
						<table class="table table-bordered"> <thead> <tr> <th>#</th> <th>Doctor's name</th> <th>Price</th> <th>action</th> </tr> </thead> <tbody>
<?php

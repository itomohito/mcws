	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Change the password</h3>
...
?>
							 ...
							 <div class="form-group"> <label for="exampleInputPassword1">Repeat the password</label> <input type="password" name="confirmpassword" class="form-control" value="" required="true"> </div>
